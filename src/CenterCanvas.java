...
import static prezoom.Main.app;
...
public class CenterCanvas extends JPanel implements MouseWheelListener, MouseListener, MouseMotionListener{
    ...
    ArrayList<ArrayList> objectsState = new ArrayList<>();
    ...
    public CenterCanvas() {
        objectsState.add(0, (ArrayList<GObject>)objects.clone());
...
//            g2.transform(at);
        ...
        for (GObject go : objects) {
            go.draw(g2);
            Main.app.inspectorPanel.update(g);
        }
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent e) {
        ...
        app.statusBar.setZoomText(String.format("Zoom: %3.2f %%",zoomFactor*100));
...
//        int my=e.getY();
        for (GObject go : objects)  {
            ...
            if (inShape) {
                ...
                System.out.println(selectedObj.cur_Attributes.x);
                System.out.println(selectedObj.cur_Attributes.y);
                System.out.println(selectedObj.cur_Attributes.width);
                System.out.println(selectedObj.cur_Attributes.height);
